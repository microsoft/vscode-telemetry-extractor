...
describe('Resolve Tests', () => {
    it('resolve inline + include', async () => {
        ...
        assert.deepStrictEqual(declarations.commonProperties.properties[0], new Property('timestamp', 'SystemMetaData', 'FeatureInsight', undefined, 'none'));
        assert.deepStrictEqual(declarations.commonProperties.properties[1], new Property('machineid', 'EndUserPseudonymizedInformation', 'FeatureInsight', undefined, 'MacAddressHash'));
        ...
        assert.deepStrictEqual(e1Properties[0], new Property('property_E1P1', 'SystemMetaData', 'FeatureInsight', undefined, 'none'));
        assert.deepStrictEqual(e1Properties[1], new Property('property_E1P2', 'CallstackOrException', 'PerformanceAndHealth', undefined, 'none'));
        assert.deepStrictEqual(e1Properties[2], new Property('property_E1P3', 'SystemMetaData', 'FeatureInsight', '1.57.0', 'none'));
        assert.deepStrictEqual(e1Properties[3], new Property('measurement_E1M1', 'SystemMetaData', 'FeatureInsight', undefined, 'none', true));
        assert.deepStrictEqual(e1Properties[4], new Property('measurement_E1M<NUMBER>', 'SystemMetaData', 'FeatureInsight', undefined, 'none', true));
    });
});